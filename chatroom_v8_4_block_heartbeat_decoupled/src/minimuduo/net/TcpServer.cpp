...
void TcpServer::newConnection(
    ...
    if (!configureTcpKeepAlive(
        ...
        // Application PING/PONG remains the deterministic detector.
        // OS keepalive is a best-effort second line of defense.
        std::cerr
            << "TCP keepalive configuration failed: "
            << keepaliveError
            << '\n';
    }
